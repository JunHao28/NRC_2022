...
class Movement:
    ...
    def gyro(self, speed, condition=None, minimumSpeed=50, override=None, inputs=None):
        outputs = [0, 0, 0]
        if inputs == None:
        ...
        while True:
            ...
            outputs = self.gyro.pid(gyroError, outputs[1], outputs[2])
            leftspeed = (speed - outputs[0]) if (speed >
