...
def section2(robot):
    ...
    #Move forward
    robot.movement.gyrodegree(-100, -180, stop=False, override=180, maximumSpeedAccel=400, minimumSpeed=240, startingSpeed=(350 if returnVal != True else 0), decelDist=90)
